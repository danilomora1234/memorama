...
@Component({
  selector: 'app-hardware-dificil',
  templateUrl: './hardware-dificil.page.html',
  styleUrls: ['./hardware-dificil.page.scss'],
})
export class HardwareDificilPage implements OnInit {
