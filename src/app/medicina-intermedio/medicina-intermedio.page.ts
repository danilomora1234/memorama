...
@Component({
  selector: 'app-medicina-intermedio',
  templateUrl: './medicina-intermedio.page.html',
  styleUrls: ['./medicina-intermedio.page.scss'],
})
export class MedicinaIntermedioPage implements OnInit {
  ...
  public imageDir = '../assets/img/insmedicos/';
  public images = ['estetoscopio','guantes','jeringuilla','laboratorio','liquido','mascarilla','microscopio','termometro','thermometer','vaccine'];
