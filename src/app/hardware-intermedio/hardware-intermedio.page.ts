...
@Component({
  selector: 'app-hardware-intermedio',
  templateUrl: './hardware-intermedio.page.html',
  styleUrls: ['./hardware-intermedio.page.scss'],
})
export class HardwareIntermedioPage implements OnInit {
  ...
  public imageDir = '../assets/img/hardware/';
  public images = ['auriculares','cctv','controlador','disco-duro','gafas','impresora','pantalla','procesador','raton','upc'];
