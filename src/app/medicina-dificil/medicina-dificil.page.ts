...
@Component({
  selector: 'app-medicina-dificil',
  templateUrl: './medicina-dificil.page.html',
  styleUrls: ['./medicina-dificil.page.scss'],
})
export class MedicinaDificilPage implements OnInit {
