...
@Component({
  selector: 'app-modo-facil-animales',
  templateUrl: './modo-facil-animales.page.html',
  styleUrls: ['./modo-facil-animales.page.scss'],
})
export class ModoFacilAnimalesPage implements OnInit {
