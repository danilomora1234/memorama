...
@Component({
  selector: 'app-comida-intermedio',
  templateUrl: './comida-intermedio.page.html',
  styleUrls: ['./comida-intermedio.page.scss'],
})
export class ComidaIntermedioPage implements OnInit {
  ...
  public imageDir = '../assets/img/comida/';
  public images = ['algodon','beber','dulces','helado','manzana','paleta','palomitas','pancho','piruli','pizza'];
