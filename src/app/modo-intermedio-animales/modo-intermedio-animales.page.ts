...
@Component({
  selector: 'app-modo-intermedio-animales',
  templateUrl: './modo-intermedio-animales.page.html',
  styleUrls: ['./modo-intermedio-animales.page.scss'],
})
export class ModoIntermedioAnimalesPage implements OnInit {
  ...
  public imageDir = '../assets/img/animales/';
  public images = ['ballena','ciervo','gorila','lemur','mariposa','mariquita','medusa'
                  ,'pajaro','soportar','zorro'];
