...
@Component({
  selector: 'app-modo-dificil-animales',
  templateUrl: './modo-dificil-animales.page.html',
  styleUrls: ['./modo-dificil-animales.page.scss'],
})
export class ModoDificilAnimalesPage implements OnInit {
