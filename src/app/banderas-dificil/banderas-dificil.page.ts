...
@Component({
  selector: 'app-banderas-dificil',
  templateUrl: './banderas-dificil.page.html',
  styleUrls: ['./banderas-dificil.page.scss'],
})
export class BanderasDificilPage implements OnInit {
